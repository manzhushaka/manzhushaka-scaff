...
public interface ExportTaskMapper
{
    ...
    ExportTask selectById(Long taskId);
    List<ExportTask> selectList(@Param("requestedBy") Long requestedBy, @Param("status") String status);
    ...
    List<ExportTask> selectRecoverable(@Param("now") Date now);
}
