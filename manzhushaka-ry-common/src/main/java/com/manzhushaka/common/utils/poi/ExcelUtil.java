package com.manzhushaka.common.utils.poi;
...
import com.manzhushaka.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    {
        String downloadPath = ManzhushakaConfig.getDownloadPath() + filename;
