...
(292, 0, '运行监控', 'DIR', 'SystemMonitor', '/monitor', NULL, NULL, 'icon-dashboard', 4, 1, 1, 0, 1, '运行监控目录', 'system', NOW(), 'system', NOW()),
(293, 292, '监控刷新', 'BUTTON', NULL, NULL, NULL, 'system:monitor:refresh', NULL, 1, 1, 1, 0, 0, '运行监控刷新按钮', 'system', NOW(), 'system', NOW()),
(297, 292, '硬件监控', 'MENU', 'SystemMonitorHardware', 'hardware', 'system/monitor-hardware', 'system:monitor:view', NULL, 1, 1, 1, 0, 0, '硬件监控菜单', 'system', NOW(), 'system', NOW()),
(298, 292, '服务监控', 'MENU', 'SystemMonitorServices', 'services', 'system/monitor-services', 'system:monitor:view', NULL, 2, 1, 1, 0, 0, '服务监控菜单', 'system', NOW(), 'system', NOW()),
(299, 292, '慢 SQL', 'MENU', 'SystemMonitorSlowSql', 'slow-sql', 'system/monitor-slow-sql', 'system:monitor:view', NULL, 3, 1, 1, 0, 0, '慢 SQL 监控菜单', 'system', NOW(), 'system', NOW()),
(300, 292, '在线日志', 'MENU', 'SystemMonitorLiveLog', 'live-log', 'system/monitor-live-log', 'system:monitor:view', NULL, 4, 1, 1, 0, 0, '在线日志监控菜单', 'system', NOW(), 'system', NOW()),
...
(284, 281, '导出任务下载', 'BUTTON', NULL, NULL, NULL, 'system:io:export:download', NULL, 2, 1, 1, 0, 0, '导出任务下载按钮', 'system', NOW(), 'system', NOW()),
...
(288, 285, '导入任务下载', 'BUTTON', NULL, NULL, NULL, 'system:io:import:download', NULL, 2, 1, 1, 0, 0, '导入任务下载按钮', 'system', NOW(), 'system', NOW()),
...
(1071, 100, 297, 'system', NOW(), 'system', NOW()),
(1072, 100, 298, 'system', NOW(), 'system', NOW()),
(1073, 101, 297, 'system', NOW(), 'system', NOW()),
(1074, 101, 298, 'system', NOW(), 'system', NOW()),
(1075, 100, 299, 'system', NOW(), 'system', NOW()),
(1076, 100, 300, 'system', NOW(), 'system', NOW()),
(1077, 101, 299, 'system', NOW(), 'system', NOW()),
(1078, 101, 300, 'system', NOW(), 'system', NOW()),
