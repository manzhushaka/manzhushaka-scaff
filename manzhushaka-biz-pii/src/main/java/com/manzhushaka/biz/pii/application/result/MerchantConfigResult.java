...
import com.manzhushaka.common.utils.DesensitizedUtil;
...
public class MerchantConfigResult {
    ...
    public static MerchantConfigResult from(MerchantProfile profile) {
        MerchantConfigResult result = new MerchantConfigResult();
        ...
        result.setUmsPaySignKeyMasked(DesensitizedUtil.password(profile.getUmsPaySignKeyEnc()));
        result.setUmsInvoiceSignKeyMasked(DesensitizedUtil.password(profile.getUmsInvoiceSignKeyEnc()));
        result.setInvoiceMsgSrc(profile.getInvoiceMsgSrc());
        result.setInvoiceSellerName(profile.getInvoiceSellerName());
        result.setInvoiceSellerTaxCode(profile.getInvoiceSellerTaxCode());
        result.setInvoiceSellerAddress(profile.getInvoiceSellerAddress());
        result.setInvoiceSellerTelephone(profile.getInvoiceSellerTelephone());
        result.setInvoiceSellerBank(profile.getInvoiceSellerBank());
        result.setInvoiceSellerAccount(profile.getInvoiceSellerAccount());
        result.setInvoicePayee(profile.getInvoicePayee());
        result.setInvoiceChecker(profile.getInvoiceChecker());
        result.setInvoiceDrawer(profile.getInvoiceDrawer());
        result.setNotifyUrl(profile.getNotifyUrl());
