...
public class TaxItemResult {
    ...
    public static TaxItemResult from(TaxItem taxItem) {
        TaxItemResult result = new TaxItemResult();
        result.setId(taxItem.getId());
        result.setTaxItemCode(taxItem.getTaxItemCode());
        result.setName(taxItem.getName());
        result.setBrevityCode(taxItem.getBrevityCode());
        result.setCategory(taxItem.getCategory());
        result.setTaxRate(taxItem.getTaxRate());
        result.setVatSpecial(taxItem.getVatSpecial());
        result.setFreeTaxType(taxItem.getFreeTaxType());
        result.setPreferPolicyFlag(taxItem.getPreferPolicyFlag());
        result.setSort(taxItem.getSort());
        result.setStatus(taxItem.getStatus());
        result.setRemark(taxItem.getRemark());
        result.setCreateTime(taxItem.getCreateTime());
        result.setUpdateTime(taxItem.getUpdateTime());
        return result;
    }
