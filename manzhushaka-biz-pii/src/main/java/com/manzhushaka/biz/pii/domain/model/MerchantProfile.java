...
public class MerchantProfile {
    ...
    public String getUmsPaySignKeyEnc() { return umsPaySignKeyEnc; }
    public void setUmsPaySignKeyEnc(String umsPaySignKeyEnc) { this.umsPaySignKeyEnc = umsPaySignKeyEnc; }
    public String getUmsInvoiceSignKeyEnc() { return umsInvoiceSignKeyEnc; }
    public void setUmsInvoiceSignKeyEnc(String umsInvoiceSignKeyEnc) { this.umsInvoiceSignKeyEnc = umsInvoiceSignKeyEnc; }
    ...
    public String toString() {
        return "MerchantProfile{id=" + id + ", deptId=" + deptId + ", merchantName='"
                + merchantName + "', umsMerchantId='" + umsMerchantId + "', status=" + status + "}";
    }
}
