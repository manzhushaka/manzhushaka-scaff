...
public class TaxItemVO {
    ...
    public static TaxItemVO from(TaxItemResult result) {
        TaxItemVO vo = new TaxItemVO();
        vo.setId(result.getId());
        vo.setTaxItemCode(result.getTaxItemCode());
        vo.setName(result.getName());
        vo.setBrevityCode(result.getBrevityCode());
        vo.setCategory(result.getCategory());
        vo.setTaxRate(result.getTaxRate());
        vo.setVatSpecial(result.getVatSpecial());
        vo.setFreeTaxType(result.getFreeTaxType());
        vo.setPreferPolicyFlag(result.getPreferPolicyFlag());
        vo.setSort(result.getSort());
