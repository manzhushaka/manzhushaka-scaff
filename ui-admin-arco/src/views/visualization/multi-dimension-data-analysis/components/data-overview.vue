  ...
  const renderData = computed(() => [
    {
      ...
      value: overviewCounts.value['内容生产量'] || 0,
      prefix: {
        icon: 'icon-edit',
    ...
    },
    {
      ...
      value: overviewCounts.value['内容点击量'] || 0,
      prefix: {
        icon: 'icon-thumb-up',
    ...
    },
    {
      ...
      value: overviewCounts.value['内容曝光量'] || 0,
      prefix: {
        icon: 'icon-heart',
    ...
    },
    {
      ...
      value: overviewCounts.value['活跃用户数'] || 0,
      prefix: {
        icon: 'icon-user',
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      data.data.forEach((el) => {
        overviewCounts.value[el.name] = el.count;
        if (el.name === '内容生产量') {
